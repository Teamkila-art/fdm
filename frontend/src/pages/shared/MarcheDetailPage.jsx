      ...
      <section style={sectionStyle}>
        ...
        {editInfos ? (
          <form onSubmit={saveInfos}>
            ...
            {!isDonation && <>
              <FormRow label="Date d'attribution">
                <input style={inputStyle} type="date" value={infosForm.date_attribution} onChange={e => setInfosForm(f => ({ ...f, date_attribution: e.target.value }))} />
              </FormRow>
              <FormRow label="Marque">
                <input style={inputStyle} value={infosForm.marque} onChange={e => setInfosForm(f => ({ ...f, marque: e.target.value }))} />
              </FormRow>
              <FormRow label="Comité de conformité">
                <input style={inputStyle} value={infosForm.comite_conformite} onChange={e => setInfosForm(f => ({ ...f, comite_conformite: e.target.value }))} />
              </FormRow>
            </>}
