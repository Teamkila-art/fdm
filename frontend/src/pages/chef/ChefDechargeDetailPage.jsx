          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
            <thead>
              <tr style={{ background: T.bgSubtle }}>
                {['Désignation', 'N° Inventaire', 'Qté', 'Type'].map((h) => (
            ...
            <tbody>
              {(decharge.lignes || []).length === 0 ? (
                ...
                const type  = l.typeLigne ?? l.type_ligne;
                return (
                  <tr key={lid} style={{ borderTop: `1px solid ${T.border}` }}>
                    ...
                    <td style={{ ...tdStyle, fontSize: 12, color: T.textMuted, textTransform: 'capitalize' }}>
                      {type === 'bien_inventaire' ? 'Bien inventaire' : type === 'consommable' ? 'Consommable' : type ?? '—'}
                    </td>
                  </tr>
                );
              })}
      ...
      <div style={card}>
        ...
        {(statut === 'non_signe' || statut === 'en_attente' || statut === 'non_generee') && (
          <div style={{
            ...
            borderRadius: T.radiusSm, display: 'flex', alignItems: 'center', gap: 10,
          }}>
